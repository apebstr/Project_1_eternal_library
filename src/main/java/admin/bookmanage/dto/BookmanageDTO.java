...
public class BookmanageDTO {
	...
	//insert용 생성자
	public BookmanageDTO(String isbn, String title, String author, String publisher, String pub_date, String contents,
			String thumbnail, String category_s) {
		super();
		this.isbn = isbn;
		this.title = title;
		this.author = author;
	...
	public String getCountisbn() {
		return countisbn;
	}

	public void setCountisbn(String countisbn) {
		this.countisbn = countisbn;
	}
